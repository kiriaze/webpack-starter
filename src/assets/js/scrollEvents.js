...
const scrollEvents = () => {
	...
	// console.log($videos);
	let $scaleImgs = document.querySelectorAll('[data-plax]');
	// 
	...
	window.addEventListener('scroll', (e) => {
		...
		// plax
		[...$scaleImgs].map($scaleImg => {
			if ( document.body.dataset.scrollDirection == 'down' ) {
				// console.log($scaleImg.getBoundingClientRect());
				// $scaleImg.style.transform = 'scale()';
			} else {
